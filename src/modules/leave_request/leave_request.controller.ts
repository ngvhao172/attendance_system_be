...
export class LeaveRequestController {
    ...
    async reject(@Param('id') id: number) {
        return this.leaveRequestService.changeLeaveRequestStatus(id, ELeaveRequest.Rejected);
    }

    @Put(':id/approve')
    async approve(@Param('id') id: number) {
        return this.leaveRequestService.changeLeaveRequestStatus(id, ELeaveRequest.Approved);
    }
}
